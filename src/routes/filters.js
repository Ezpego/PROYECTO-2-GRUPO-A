...
router.get(
  ...
  wrapWithCatch(async (req, res) => {
    // NO DESCOMENTAR ESTO //const currentUser = req.currentUser;
    ...
    //Parte añadida por gabriel 1/2/2024--------------!!!!!!!
...
router.get(
  ...
  wrapWithCatch(async (req, res) => {
    const currentUser = req.currentUser;
    // añadimos dato id para ambos gupos
    ...
    // simplificacion datos enviados editado Gabriel !!!!!!!!!
    res.json({
      muscle: group_muscle,
